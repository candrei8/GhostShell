    ...
    <div className="flex flex-col h-full bg-transparent">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-white/10 shrink-0">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="rounded-md bg-[#38bdf8]/10 px-1.5 py-0.5 text-[10px] font-medium text-[#38bdf8]">
      ...
      <div className="flex-1 overflow-y-auto sidebar-scroll p-3 space-y-3">
        {activeSessionRows.map(({ session, sessionTitle, providerColor, visibleSubAgents }) => (
          <div key={session.id} className="rounded-xl border border-white/10 bg-white/[0.02] overflow-hidden">
