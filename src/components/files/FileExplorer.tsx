...
export function FileExplorer() {
  ...
  return (
    <div ref={explorerRef} className="flex h-full flex-col bg-transparent">
      <div className="flex items-center justify-between border-b border-white/10 px-4 py-3 shrink-0">
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            <span className="inline-flex h-8 w-8 items-center justify-center rounded-xl border border-[#38bdf8]/30 bg-[#38bdf8]/10 text-[#38bdf8]">
      ...
      <div className="border-b border-white/10 px-3 py-2.5 shrink-0">
        <div className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/[0.02] px-3 py-2 focus-within:border-white/20 transition-colors">
          ...
          {createMode && (
            <div className="border-b border-white/10 px-3 py-2">
              <div className="ghost-toolbar-surface flex flex-wrap items-center gap-2 rounded-xl px-3 py-2">
                <span className="ghost-soft-pill inline-flex items-center gap-1 rounded-full px-2 py-1 text-[10px] uppercase tracking-[0.16em] text-[#38bdf8]">
                ...
                <input
                  ...
                  className="min-w-[180px] flex-1 rounded-lg border border-white/10 bg-white/[0.02] px-3 py-2 text-xs text-ghost-text outline-none transition-colors focus:border-[#38bdf8]/30"
                />
                <div className="flex items-center gap-1">
                  <button
                    onClick={() => void handleCreateEntry()}
                    className="rounded-full border border-[#38bdf8]/30 bg-[#38bdf8]/10 px-3 py-1 text-[10px] uppercase tracking-[0.16em] text-[#38bdf8] transition-colors hover:bg-[#38bdf8]/20"
                  >
                    Create
                  </button>
                  <button
            ...
            <div className="border-b border-white/10 px-3 py-2">
              <div className="ghost-toolbar-surface flex flex-wrap items-center justify-between gap-2 rounded-xl px-3 py-2">
                <div className="flex min-w-0 items-center gap-2">
                  <span className="inline-flex h-7 w-7 items-center justify-center rounded-lg border border-[#38bdf8]/30 bg-[#38bdf8]/10 text-[#38bdf8]">
