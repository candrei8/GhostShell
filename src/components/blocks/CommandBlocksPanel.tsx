    ...
    <div className="flex h-full flex-col bg-transparent">
      ...
      <div className="border-b border-white/10 px-3 py-2.5 shrink-0">
        ...
        <div className="mt-2 flex items-center gap-2 text-[10px] text-white/20">
          ...
          {summary.running > 0 && <span className="text-[#38bdf8]/60">{summary.running} running</span>}
      ...
      <div className="min-h-0 flex-1 overflow-y-auto sidebar-scroll p-2">
        {filteredBlocks.length === 0 ? (
          <div className="flex min-h-[140px] flex-col items-center justify-center rounded-xl border border-dashed border-white/10 text-center">
              ...
              return (
                <button
                  ...
                  className={`w-full rounded-xl border px-3 py-2 text-left transition-all ${
                    isSelected
                      ? 'border-[#38bdf8]/30 bg-white/[0.03]'
                  ...
                  <div className="flex items-start justify-between gap-2">
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-1.5">
                        ...
                        {item.block.bookmarked && <BookmarkCheck className="h-3 w-3 shrink-0 text-[#38bdf8]/50" />}
                      </div>
            ...
            <div className="rounded-xl border border-white/10 bg-white/[0.02] p-3">
              ...
              <div className="mt-2.5 flex flex-wrap gap-1">
                <button
                  ...
                  className="inline-flex items-center gap-1 rounded-md border border-[#38bdf8]/20 bg-[#38bdf8]/10 px-2 py-1 text-[10px] font-medium text-[#38bdf8] transition-colors hover:bg-[#38bdf8]/20"
                >
              ...
              {/* Output preview */}
              <div className="mt-2.5 overflow-hidden rounded-lg border border-white/10 bg-white/[0.02]">
