    ...
    <div className="flex flex-col h-full bg-transparent">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-white/[0.04] shrink-0">
        <div className="flex items-center gap-2.5 min-w-0">
          <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-violet-400/10 text-violet-300/80">
      ...
      <div className="px-3 py-2.5 border-b border-white/[0.03] shrink-0">
        ...
        <div className="mt-2 flex items-center gap-1.5">
          ...
          {query && (
            <span className="rounded-md bg-violet-400/10 px-1.5 py-0.5 text-[10px] font-medium text-violet-300/70">
      ...
      <div className="flex-1 overflow-y-auto sidebar-scroll p-2">
        {filteredHistory.length === 0 ? (
          <div className="flex h-28 flex-col items-center justify-center rounded-xl border border-dashed border-white/[0.06] text-center">
          ...
          <div className="flex flex-col gap-0.5">
            {filteredHistory.map((entry, i) => (
              ...
              >
                <div className="mt-1.5 h-1 w-1 shrink-0 rounded-full bg-white/10 transition-colors group-hover:bg-violet-400/60" />
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-0.5 flex items-center gap-1.5 text-[10px] text-white/20">
                    ...
                    {activeSessionId && (
                      <span className="rounded-md bg-violet-400/8 px-1 py-px text-[9px] text-violet-300/50 opacity-0 transition-opacity group-hover:opacity-100">
                        replay
                      </span>
                    )}
                  </div>
